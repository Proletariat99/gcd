...
# This is the code book for getting & cleaning data, final project.
...
The 6 files were:
* X_test.txt   The main data file for test subjects
* X_train.txt  The main data file for train subjects
* y_test.txt  Contains the activity code for test subjects
* y_train.txt  Contains the ativity code for train subjects
* subject_test.txt  Contains the subject identification code (an integer) for test subjects
* subject_train.txt  Contains the subject identification code (an integer) for train subjects
